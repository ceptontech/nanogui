/*
    nanogui/hscrollpanel.h -- Adds a horizontal scrollbar around a widget
...
/**
 * \class HScrollPanel hscrollpanel.h nanogui/hscrollpanel.h
 *
 * \brief Adds a horizontal scrollbar around a widget that is too big to fit into
 *        a certain area.
 */
class NANOGUI_EXPORT HScrollPanel : public Widget {
public:
    HScrollPanel(Widget *parent);
